/**
 * @openagentpay/wallet-litecoin public entrypoint.
 *
 ...
 * offline — the cryptographic identity (keypair → tltc1q… address → DER
...
export {
  ...
  PROTOCOL_ID,
  WALLET_PROVIDER_ID,
  X_PAYMENT_LITECOIN_HEADER,
  // Types
  type LitecoinConnectorConfig,
...
export {
  ...
  hrpForNetwork,
  WITNESS_VERSION_V0,
  type LitecoinKeypair,
  type LitecoinNetwork,
  type RealLitecoinSignerConfig,
  type LitecoinSignResult,
} from "./real-signer.js";
